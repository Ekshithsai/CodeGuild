...
const ProblemCard = ({
  ...
  // Use parent-provided bookmark state if available, otherwise fetch
  const bookmarked = isBookmarkedProp !== undefined ? isBookmarkedProp : isBookmarked;
  ...
  }, [titleSlug, backend, isBookmarkedProp]);
  ...
  const toggleBookmark = async (e) => {
    ...
    try {
      ...
      if (onBookmarkToggle) onBookmarkToggle(titleSlug, !bookmarked);
    } catch (error) {
